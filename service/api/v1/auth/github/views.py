...
from apps.auth.providers.github import GithubAuthenticationProvider
from rest_framework.response import Response


class GithubAuthenticationViewSet(AuthenticationViewSet):
    auth_provider = GithubAuthenticationProvider
